...
/// <param name="Kind">Which of the entry's episode numberings those numbers belong to. Ordinary episodes unless the season is filled from the entry's other episodes, as a season of films broadcast as television episodes is.</param>
