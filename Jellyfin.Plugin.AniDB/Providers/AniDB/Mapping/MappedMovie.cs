...
/// <summary>
/// A film identified from an id another provider had already settled on, and what identified it.
/// </summary>
/// <param name="Episode">The AniDB entry the film is, and which of its episodes holds it. A film AniDB registers in its own right is that entry's first ordinary episode; one it holds inside another entry is a later episode, or a special, or one of the other episodes.</param>
